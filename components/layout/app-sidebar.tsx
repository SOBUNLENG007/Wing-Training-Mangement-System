...
const trainerAdminLinks = [
  ...
  { href: "/dashboard/sessions", label: "Training Sessions", icon: GraduationCap },
...
export function AppSidebar({
  ...
  return (
    <>
            ...
            <div className="space-y-2">
              <Link
                ...
                className={cn(
                  ...
                  collapsed
                    ? cn(
                        "justify-center p-2 h-11 w-11 mx-auto",
                        isSettingsActive
                          ? "bg-[#1f6fff] text-white shadow-[0_8px_24px_rgba(31,111,255,0.28)]"
                          : "text-white/80 hover:bg-white/5"
                      )
              ...
              {/* 3. TRIGGER MODAL INSTEAD OF LOGGING OUT DIRECTLY */}
              <button
                type="button"
      ...
      {/* --- LOGOUT CONFIRMATION MODAL (Matching your image) --- */}
      {showLogoutModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-[24px] w-full max-w-[360px] shadow-2xl p-8 text-center animate-in zoom-in-95 duration-200">
            
            <h3 className="text-[26px] font-bold text-slate-500 mb-3 tracking-tight">
              Log Out
            </h3>
            ...
            <div className="flex justify-center gap-4">
              <button 
                ...
                className="px-6 py-2.5 rounded-2xl border border-slate-200 text-slate-500 font-medium hover:bg-slate-50 transition-colors w-[120px]"
              >
                Cancel
              </button>
              <button 
                onClick={handleLogout}
                className="px-6 py-2.5 rounded-2xl bg-red-600 text-white font-medium hover:bg-red-700 shadow-sm transition-colors w-[120px]"
              >
                Log out
              </button>
            </div>
